        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="font-size:12px;">Agents</li>
            </ol>
          </div>
        </div>
      </div>
                            ...
                            echo "<td>
                                    <div class='btn-group'>
                                      ...
                                      <div class='dropdown-menu' role='menu'>
                                        <a class='dropdown-item' data-toggle='modal' data-target='#updateCustomerModal' onclick='fillUpdateForm($a_id, $a_firstname, $a_middlename, $a_lastname, $a_contactno, $a_fulladdress)' style='font-size:12px;'>Update Records</a>
                                        <div class='dropdown-divider'></div>
                                        <a class='dropdown-item' data-toggle='modal' data-target='#deleteCustomerModal' onclick='confirmDelete(".htmlspecialchars($row['agent_id'], ENT_QUOTES, 'UTF-8').")' style='font-size:12px;'>Delete Records</a>
                                      </div>
                                    </div>
                                  </td>";
                            echo "</tr>";
