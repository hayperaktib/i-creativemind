            ...
            <div class="modal-body bg-light p-3">
                ...
                <div class="text-center mb-3">
                    ...
                    <div class="mt-2">
                        ...
                        <span class="badge badge-success px-2 py-1" style="font-size: 0.75rem;">Super Admin</span>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-2">
                            <div class="bg-white rounded p-3 shadow-sm h-100">
                                ...
                                <div class="mb-2">
                                    <label for="user_email" class="form-label text-dark font-weight-medium">Email Address</label>
                                    <input type="email" class="form-control form-control-modern form-control-compact form-control-readonly" id="user_email" readonly
                                           value="<?php echo !empty($user_email) ? htmlspecialchars($user_email) : 'No email address found'; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function removeBackdrop() {
        ...
        document.querySelector('#updateProfileModal .close').addEventListener('click', function() {
        removeBackdrop();
    });
